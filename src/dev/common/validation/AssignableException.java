...
public class AssignableException extends ValidationException {
    ...
    public static final String LAYOUT_MESSAGE = "The %s must not be assignable from %s";

    public static final String DEFAULT_MESSAGE = "The source type must not be assignable from the subsequent type";
